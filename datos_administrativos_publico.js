...
/* ============================
   Datos Administrativos (PÚBLICO)
   Lectura y render SOLO-VISTA
============================ */
(function () {
  const STORAGE_KEY = "datos_administrativos_v1"; // mantiene tu clave
  ...
  function render(data) {
    ...
    const rows = Array.isArray(data) && data.length
      ? data
      : [{ asesoria: "", nombre: "", correo: "" }]; // mantiene tu “siempre visible”
  ...
  // Actualiza si el admin edita desde otra pestaña/equipo
