...
(function () {
  ...
  // Config
  // -------------------------
  const STORAGE_KEY = "tablaPoa_direccion_v1"; // se guarda como YYYY_tablaPoa_direccion_v1
  const DETAIL_VIEW_PAGE = "vista_prap.html";  // página de detalle SOLO VISTA (le pasamos ?id=&year=)
  const COLS = 4; // Áreas, Objetivos, Meta, Indicador (total columnas = 1 + 4 = 5)
  ...
  // Re-render si cambian datos del AÑO activo (en otra pestaña)
