...
/* ============================
   Bloqueo de “volver hacia adelante” (no-forward)
============================ */
(function () {
...
/* ============================
   Justificación — PÚBLICO (lectura)
============================ */
(function (){
  const PRIMARY_KEY  = "justificacion_v1";        // objeto normalizado
  const FALLBACK_KEY = "informacion_paneles_v1";  // array simple (compatibilidad)
  ...
  function leer() {
    ...
    if (Array.isArray(arr)) {
      // adapta array → objeto normalizado
